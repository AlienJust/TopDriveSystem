...
{
    internal class Group99SettingsViewModel : ViewModelBase
    {
        ...
        private bool IsWriteEnabled
        {
            get
            {
                ...
                var resultForEngine = AnyEngineParameterSetted && _engineSettingsStorage.EngineSettings != null;
        ...
        private void ImcwParameterVmOnPropertyChanged(object sender, PropertyChangedEventArgs propertyChangedEventArgs)
        {
            if (propertyChangedEventArgs.PropertyName == "Bit13")
            {
                if (_imcwParameterVm.Bit13.HasValue)
                    Parameter07Vm.SelectedComboItem = _imcwParameterVm.Bit13.Value
                        ? Parameter07Vm.ComboItems.First()
                        : Parameter07Vm.ComboItems.Last();
