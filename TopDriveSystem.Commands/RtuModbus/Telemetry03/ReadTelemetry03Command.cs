...
namespace TopDriveSystem.Commands.RtuModbus.Telemetry03
{
    public class ReadTelemetry03Command : IRrModbusCommandWithReply, IRrModbusCommandResultGetter<ITelemetry03>,
        IRrModbusCommandWithTestReply
    {
        private readonly RtuModbusReadHoldingRegistersCommand _rtuModbusCmd =
            new RtuModbusReadHoldingRegistersCommand(300, 11);
