...
{
    internal class Group25SettingsViewModel : ViewModelBase
    {
        ...
        public Group25SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger,
            ...
            IAinsCounter ainsCounter)
        {
            ...
            Parameter01Vm =
                new ParameterDecimalEditCheckViewModel("25.01. Уставка моментного тока", "f0", -10000, 10000);
