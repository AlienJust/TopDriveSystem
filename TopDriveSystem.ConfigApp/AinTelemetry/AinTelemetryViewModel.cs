...
namespace TopDriveSystem.ConfigApp.AinTelemetry
{
    internal class AinTelemetryViewModel : ViewModelBase, ICyclePart
    {
        ...
        public bool? RadiatorKeysTemperatureRiseTo85DegreesExcess =>
            _telemetry?.RadiatorKeysTemperatureRiseTo85DegreesExcess;
        ...
        public bool? ConfigChangeDuringParallelWorkConfirmationNeed =>
            _telemetry?.ConfigChangeDuringParallelWorkConfirmationNeed;
        ...
        public double? AfterFilterSpeedControllerFeedbackFriquency =>
            _telemetry?.AfterFilterSpeedControllerFeedbackFriquency;
