...
namespace TopDriveSystem.ConfigApp.LookedLikeAbb.Group106Settings.ImvcParameter
{
    internal class ImcwParameterViewModel : ViewModelBase
    {
        private bool? _bit00;
        private bool? _bit01;
        private bool? _bit02;
        ...
        public ImcwParameterViewModel()
        {
            ...
            Bit1011Vms = new[]
                {"0 - одиночная работа", "1 - 2 блока, есть только ведомый 1", "2 - 3 блока", "3 - резерв"};
        ...
        private void TryBuildFullValue()
        {
            ...
            )
            {
                ...
                for (var i = 0; i < Bit0809Vms.Length; ++i)
                ...
                for (var i = 0; i < Bit1011Vms.Length; ++i)
