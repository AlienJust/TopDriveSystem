...
namespace TopDriveSystem.Commands.RtuModbus.Telemetry01
{
    public class ReadTelemetry01Command : IRrModbusCommandWithReply, IRrModbusCommandResultGetter<ITelemetry01>,
        IRrModbusCommandWithTestReply
    {
        private readonly RtuModbusReadHoldingRegistersCommand _rtuModbusCmd =
            new RtuModbusReadHoldingRegistersCommand(100, 19);
