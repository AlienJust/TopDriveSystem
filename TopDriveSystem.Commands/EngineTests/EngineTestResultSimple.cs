namespace TopDriveSystem.Commands.EngineTests
{
    internal class EngineTestResultSimple : IEngineTestResult
    {
        public EngineTestResultSimple(byte testResultByte, short rs, double rr, double lsI, double lrI, double lm,
            short flNom, double j, double tr, double roverL)
        {
