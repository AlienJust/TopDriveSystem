...
using TopDriveSystem.ConfigApp.LookedLikeAbb.Parameters.ParameterBooleanEditCheck;
...
{
    internal class Group102SettingsViewModel : ViewModelBase
    {
