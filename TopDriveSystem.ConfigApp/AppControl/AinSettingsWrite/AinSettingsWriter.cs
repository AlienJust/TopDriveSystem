	...
	internal class AinSettingsWriter : IAinSettingsWriter {
		...
		public void WriteSettingsAsync(IAinSettingsPart settingsPart, Action<Exception> callback) {
			...
			_ainSettingsReader.ReadSettingsAsync(0, false, (readSettingsException, readedAin1Settings) => {
				...
				settingsForAin1.ModifyFromPart(new AinSettingsPartWritable { Ia0 = readedAin1Settings.Ia0, Ib0 = readedAin1Settings.Ib0, Ic0 = readedAin1Settings.Ic0, Udc0 = readedAin1Settings.Udc0 }); // ��� ��������� ������ ������ ���������� �����������
				...
				if (ainsCountToWriteSettings == 1) {
					...
					settingsForAin1.Imcw = (ushort)(settingsForAin1.Imcw & 0xF0FF); // ���� 8,9,10 � 11 ��������, �������� ������
					...
					settingsForAin1.Imcw = (ushort)(settingsForAin1.Imcw & 0xF0FF); // ���� 8,9,11 ��������, ��� ���� � �������
					settingsForAin1.Imcw = (ushort)(settingsForAin1.Imcw | 0x0400); // ��� 10 �������, ��� ���� � �������
						...
						(sendException, replyBytes) => {
							...
							_ainSettingsReader.ReadSettingsAsync(0, true, (exceptionReRead1, settings1ReReaded) => {
								...
								_ainSettingsReader.ReadSettingsAsync(1, false, (readSettings2Exception, readedAin2Settings) => {
									...
									settingsForAin2.Imcw = (ushort)(settingsForAin2.Imcw & 0xF0FF); // ���� 9,11 ��������, ������� 1
									settingsForAin2.Imcw = (ushort)(settingsForAin2.Imcw | 0x0500); // ���� 8,10 ��������,, ������� 1
					...
					settingsForAin1.Imcw = (ushort)(settingsForAin1.Imcw & 0xF0FF); // ���� 8.9.10 ��������, ��� ���� � �������
					settingsForAin1.Imcw = (ushort)(settingsForAin1.Imcw | 0x0800); // ��� 11 �������, ��� ���� � �������
						...
						(sendException, replyBytes) => {
							...
							_ainSettingsReader.ReadSettingsAsync(0, true, (exceptionReRead1, settings1ReReaded) => {
								...
								_ainSettingsReader.ReadSettingsAsync(1, false, (readSettings2Exception, readedAin2Settings) => {
									...
									settingsForAin2.ModifyFromPart(settingsPart); // ����������� �������� ����������, ��������� �������������
									settingsForAin2.ModifyFromPart(new AinSettingsPartWritable { Ia0 = readedAin2Settings.Ia0, Ib0 = readedAin2Settings.Ib0, Ic0 = readedAin2Settings.Ic0, Udc0 = readedAin2Settings.Udc0 }); // ��� ��������� ������ ������ ���������� �����������
									settingsForAin2.Imcw = (ushort)(settingsForAin2.Imcw & 0xF0FF); // ���� 9,10 ��������, ������� 1
									settingsForAin2.Imcw = (ushort)(settingsForAin2.Imcw | 0x0900); // ���� 8,11 ��������, ������� 1
											...
											_ainSettingsReader.ReadSettingsAsync(1, true, (exceptionReRead2, settings2ReReaded) => {
												...
												_ainSettingsReader.ReadSettingsAsync(2, false, (readSettings3Exception, readedAin3Settings) => {
													if (readSettings3Exception != null) {
														callback(new Exception("�� ������� �������� ���������, �������� ������ ��� ��������������� �� ������ �� ����� ���1 - ��� ������ �� BsEthernet", readSettings3Exception));
														return;
													}
													...
													settingsForAin3.Imcw = (ushort)(settingsForAin3.Imcw & 0xF0FF); // ���� 8,10 ��������, ������� 2
													settingsForAin3.Imcw = (ushort)(settingsForAin3.Imcw | 0x0A00); // ���� 9,11 ��������, ������� 2
