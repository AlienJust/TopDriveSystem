namespace TopDriveSystem.Commands.BsEthernetNominals
{
    internal class BsEthernetNominalsSimple : IBsEthernetNominals
    {
        public BsEthernetNominalsSimple(
            short ratedRotationFriquencyCalculated,
            short ratedPwmModulationCoefficient,
            short ratedMomentumCurrentSetting,
            short ratedRadiatorTemperature,
            short ratedDcBusVoltage,
            short ratedAllPhasesCurrentAmplitudeEnvelopeCurve,
            short ratedRegulatorCurrentDoutput,
            short ratedRegulatorCurrentQoutput,
            short ratedFriquencyIntensitySetpointOutput,
            short ratedFlowSetting,
            short ratedMeasuredMoment,
            short ratedSpeedRegulatorOutputOrMomentSetting,
            short ratedMeasuredFlow,
