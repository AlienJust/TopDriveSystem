...
{
    internal class Group24SettingsViewModel : ViewModelBase
    {
        ...
        public Group24SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger,
            ...
            IAinsCounter ainsCounter)
        {
            ...
            Parameter01Vm =
                new ParameterDecimalEditCheckViewModel("24.01. Пропорциональный коэф. регулятора скорости", "f8",
                    -128.0m, 127.99609375m) {Increment = 0.00390625m};
            Parameter02Vm =
                new ParameterDecimalEditCheckViewModel("24.02. Интегральный коэф. регулятора скорости", "f6", -128.0m,
                    128.0m) {Increment = 0.000001m}; // min step = 1 / 16777216.0 = 0,000000059604644775390625
